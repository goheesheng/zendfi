    ...
    return (
      <div className="bg-white dark:bg-zend-card rounded-2xl p-12 text-center border border-gray-200 dark:border-zend-border shadow-sm">
        <div className="w-20 h-20 rounded-full bg-zend-blue/8 flex items-center justify-center mx-auto mb-5 animate-float">
          <svg className="w-10 h-10 text-zend-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
        </div>
        <p className="text-gray-900 dark:text-white font-semibold mb-1">No active loans</p>
        <p className="text-sm text-gray-400 dark:text-gray-500 mb-6">Your active and pending loans will appear here once you borrow.</p>
